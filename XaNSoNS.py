...
def run(XML,version="OMP",Nproc=4,Nthread=0,devID=0,platID=0,backup=True,CIFcheck=True,FFcheck=True):
    argstr=""
    if backup:
        if CIFcheck:
            cif2xml(opt.XML)
...
if  __name__ ==  "__main__" :
    ...
    parser.add_option("-d", "--deviceID", dest="devID", type='int',default=0,
                      help="CUDA or OpenCL device ID")
    parser.add_option("-p", "--platformID", dest="platID", type='int',default=0,
