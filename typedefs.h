...
#define SQR(x) ((x)*(x)) //square of x definition
...
//AIfilename - filename for form factors table
	unsigned int scenario, source, Nblocks, Ntype, Nfi, Nhist, PDFtype, EulerConvention;
...
class block {
public:
	vector <unsigned int> NatomType,NatomTypeAll;
